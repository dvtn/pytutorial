...
__author__ = "David Tian"
__copyright__ = "Copyright 2015-2020, david.tian@live.com"


class Category(models.Model):
    name = models.CharField(verbose_name="类型名称", max_length=20)
    description = models.CharField(verbose_name="备注说明", max_length=100)
...
class Product(models.Model):
    ...
    discontinued = models.BooleanField('是否停产', default=False)
